...
import 'package:ansvel/loginapp/src/features/authentication/models/user_model.dart';
import 'package:ansvel/loginapp/src/repository/authentication_repository/authentication_repository.dart';
  ...
  updateRecord(UserModel user) async {
    try {
      ...
      Helper.successSnackBar(
        ...
        message: 'Profile Record has been updated!',
      );
    } catch (e) {
      Helper.errorSnackBar(title: 'Error', message: e.toString());
    }
